...
def parse_args():
    ...
    parser.add_argument('--no-skip-archived', action='store_true')
    parser.add_argument('--days', type=int, default=DEFAULT_MAX_DAYS_OLD)
    parser.add_argument('--oldest-items', type=int, default=DEFAULT_OLDEST_ITEMS)
...
def main():
    ...
    if args.repos is None:
        repos = get_repos(args.owner, skip_archived=not args.no_skip_archived)
    else:
        repos = args.repos
